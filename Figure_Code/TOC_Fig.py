...
# Plots Figure 2 in the Manuscript
def PlotFig2():
	...
	ax2.hlines(1.491,100*(lambda_low_0-1),100*(lambda_high_0-1),lw=2,ls='-',color='black')
	...
	ax2.text(-11.2,1.493,'coexistence',fontsize=16)
	...
	ax1.set_ylabel('Molecular Tilt, \Huge $\psi$',fontsize=16,rotation=90)#,labelpad=15)
	...
	ax2.set_ylabel('Free Energy',fontsize=16,rotation=90)
	ax2.set_xlabel(r'Axial Strain, \Huge $\varepsilon$',fontsize=16)
	ax2.set_xlim(-20,10)
	ax2.set_ylim(1.49,1.52)
